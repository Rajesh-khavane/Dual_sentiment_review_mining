  		                        ...
  		                        <div class="col-sm-10">
               						<div class="row">
                                  		<% 
                                        	...
                                        	Product pc2=(Product)abstractDao.getById("id",9, Product.class);
                                    ...
                                    <div class="panel panel-primary">
                                     ...
                                     <div class="panel panel-primary">
                                        ...
                                        <div class="panel panel-primary">
                                        <div class="panel-heading">
                                          <h3><b>  <%=pc2.getProductName()  %></b></h3>
                                        </div>
                                        <div class="panel-body" style="display: flex; justify-content: center; align-items: center;">
                                             <img src="Uploads/<%=pc2.getProductPath() %>"  alt="Cinque Terre" width="250" height="300">
                                                     <hr><p style="padding-left:10px">
                                          <b>  Product : </b><%=pc2.getProductName()  %>
                                            <br>
                                       
                                           <b> Category : </b><%=pc2.getProductCategory().getCategory() %>
                                            <br>
                                          <b>  Price  : </b>&#8377; <%=pc2.getProductPrice() %>
                                            <br>
                                          <b>  Color  : </b><%=pc2.getColor() %>
                                            <br>
                                          <b>  Weight  :</b> <%=pc2.getWeight() %>
                                         	<br>
                                          <b>  Features  : </b><%=pc2.getFeatures() %><br>
                                          <center><img src="SentimentChart?productId=9" width="360" height="250"></center></p>
                                        </div>
